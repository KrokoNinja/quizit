...
export const updateUsername = async (prevState: {error: undefined | string}, formData: FormData) => {
  const session = await getSession();
...
export const deleteQuestion = async (prevState: {error: undefined | string}, formData: FormData) => {
...
export const requestQuestion = async (prevState: {error: undefined | string}, formData: FormData) => {
...
export const editQuestion = async (prevState: {error: undefined | string}, formData: FormData) => {
...
export const createTeam = async (prevState: {error: undefined | string}, formData: FormData) => {
  ...
  export const createCourse = async (prevState: {error: string | undefined}, formData: FormData) => {
